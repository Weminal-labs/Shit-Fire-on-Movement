...
import {
  CHAINID,
  TOKEN_ADDRESS_MOVEMENT,

  CONTRACT_ADDRESS_MOVEMENT,

  BLOCK_EXPLORER_MOVEMENT,
...
export default function CleanForm() {
  ...
  switch (chainId) {
    case CHAINID.MOVEMENT:
      contractAddress = CONTRACT_ADDRESS_MOVEMENT;
      tokenAddress = TOKEN_ADDRESS_MOVEMENT;
      blockexplorer = BLOCK_EXPLORER_MOVEMENT;
      break;
    default:
